    ...
    <>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 text-sm text-primary-foreground/80">Vocabulary path, Aleph-bet, Syllables, Nouns, or Ultimate. Pick from the Game menu.</p>
        </Link>
        <a
          href="#study-mode"
      ...
      >
        ...
        <span>
          ...
          <span className="mt-1 block text-sm text-muted">
            Spell the letters, hear the Hebrew, then the English name and meaning. Made for the car.
          </span>
        </span>
      </Link>
