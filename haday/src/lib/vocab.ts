...
export const VOCAB: VocabItem[] = [
  ...
  { id: "lo", hebrew: "לֹא", translit: "lōʾ", gloss: "not, no", alts: ["not", "no"], pos: "particle", chapter: 8, freq: 5184 },
  { id: "asher", hebrew: "אֲשֶׁר", translit: "ʾăšer", gloss: "who, which, that", alts: ["who", "which", "that", "whom"], pos: "particle", chapter: 8, freq: 5503 },
  { id: "ki", hebrew: "כִּי", translit: "kî", gloss: "that, because", alts: ["because", "that", "for", "when"], pos: "particle", chapter: 8, freq: 4484 },
  { id: "gam", hebrew: "גַּם", translit: "gam", gloss: "also, even", alts: ["also", "even", "moreover"], pos: "particle", chapter: 8, freq: 769 },
  { id: "hinneh", hebrew: "הִנֵּה", translit: "hinnēh", gloss: "behold, here is", alts: ["behold", "look", "here"], pos: "particle", chapter: 8, freq: 1061 },
  { id: "attah-now", hebrew: "עַתָּה", translit: "ʿattâ", gloss: "now", alts: ["now", "at this time"], pos: "particle", chapter: 8, freq: 435 },
  { id: "sham", hebrew: "שָׁם", translit: "šām", gloss: "there", alts: [], pos: "particle", chapter: 8, freq: 833 },
  { id: "mah", hebrew: "מָה", translit: "mâ", gloss: "what", alts: ["what", "how"], pos: "particle", chapter: 8, freq: 745 },
  { id: "mi", hebrew: "מִי", translit: "mî", gloss: "who", alts: [], pos: "particle", chapter: 8, freq: 422 },
  { id: "ein", hebrew: "אֵין", translit: "ʾên", gloss: "there is not", alts: ["there is not", "none", "without"], pos: "particle", chapter: 8, freq: 789 },
  { id: "yesh", hebrew: "יֵשׁ", translit: "yēš", gloss: "there is", alts: ["there is", "there are"], pos: "particle", chapter: 8, freq: 138 },
  { id: "od", hebrew: "עוֹד", translit: "ʿôd", gloss: "still, yet, again", alts: ["still", "yet", "again", "more"], pos: "particle", chapter: 8, freq: 491 },
  { id: "raq", hebrew: "רַק", translit: "raq", gloss: "only", alts: ["only", "except"], pos: "particle", chapter: 8, freq: 109 },
  { id: "im-if", hebrew: "אִם", translit: "ʾim", gloss: "if", alts: ["if", "whether"], pos: "particle", chapter: 8, freq: 1060 },
  { id: "al-neg", hebrew: "אַל", translit: "ʾal", gloss: "do not", alts: ["do not", "not", "don't"], pos: "particle", chapter: 8, freq: 730 },
  { id: "na", hebrew: "נָא", translit: "nāʾ", gloss: "please, now", alts: ["please", "now", "I pray"], pos: "particle", chapter: 8, freq: 405 },
  { id: "o", hebrew: "אוֹ", translit: "ʾô", gloss: "or", alts: [], pos: "particle", chapter: 8, freq: 321 },
  { id: "ken", hebrew: "כֵּן", translit: "kēn", gloss: "thus, so", alts: ["thus", "so", "yes"], pos: "particle", chapter: 8, freq: 769 },
  { id: "lama", hebrew: "לָמָּה", translit: "lāmmâ", gloss: "why", alts: ["why"], pos: "particle", chapter: 8, freq: 178 },
  { id: "ani", hebrew: "אֲנִי", translit: "ʾănî", gloss: "I", alts: ["i", "me"], pos: "pron", chapter: 8, freq: 870 },
  { id: "anoki", hebrew: "אָנֹכִי", translit: "ʾānōkî", gloss: "I (emphatic)", alts: ["i", "i myself"], pos: "pron", chapter: 8, freq: 359 },
  { id: "attah", hebrew: "אַתָּה", translit: "ʾattâ", gloss: "you (m.s.)", alts: ["you", "thou"], pos: "pron", chapter: 8, freq: 743 },
  { id: "at", hebrew: "אַתְּ", translit: "ʾatt", gloss: "you (f.s.)", alts: ["you"], pos: "pron", chapter: 8, freq: 74 },
  { id: "hu", hebrew: "הוּא", translit: "hûʾ", gloss: "he, that", alts: ["he", "that", "it"], pos: "pron", chapter: 8, freq: 1400 },
  { id: "hi", hebrew: "הִיא", translit: "hîʾ", gloss: "she, that", alts: ["she", "that", "it"], pos: "pron", chapter: 8, freq: 490 },
  { id: "anahnu", hebrew: "אֲנַחְנוּ", translit: "ʾănaḥnû", gloss: "we", alts: ["we", "us"], pos: "pron", chapter: 8, freq: 121 },
  { id: "attem", hebrew: "אַתֶּם", translit: "ʾattem", gloss: "you (m.p.)", alts: ["you", "you all"], pos: "pron", chapter: 8, freq: 283 },
  { id: "hem", hebrew: "הֵם", translit: "hēm", gloss: "they (m.)", alts: ["they"], pos: "pron", chapter: 8, freq: 500 },
  { id: "zeh", hebrew: "זֶה", translit: "zeh", gloss: "this (m.)", alts: ["this"], pos: "pron", chapter: 8, freq: 1178 },
  { id: "zot", hebrew: "זֹאת", translit: "zōʾt", gloss: "this (f.)", alts: ["this"], pos: "pron", chapter: 8, freq: 604 },
  { id: "elleh", hebrew: "אֵלֶּה", translit: "ʾēlleh", gloss: "these", alts: ["these"], pos: "pron", chapter: 8, freq: 745 },

  { id: "hadash", hebrew: "חָדָשׁ", translit: "ḥādāš", gloss: "new", alts: [], pos: "adj", chapter: 8, freq: 53 },
  { id: "zakar", hebrew: "זָכָר", translit: "zākār", gloss: "male", alts: [], pos: "noun", chapter: 8, freq: 82 },
  { id: "neqebah", hebrew: "נְקֵבָה", translit: "nəqēbâ", gloss: "female", alts: [], pos: "noun", chapter: 8, freq: 22 },

  // extras parked from earlier ch 3 (not BBH ch. 3)
  { id: "am", hebrew: "עַם", translit: "ʿam", gloss: "people", alts: ["nation"], pos: "noun", chapter: 8, freq: 1867 },
  { id: "et-time", hebrew: "עֵת", translit: "ʿēt", gloss: "time, season", alts: ["time", "season"], pos: "noun", chapter: 8, freq: 296 },
  { id: "hodesh", hebrew: "חֹדֶשׁ", translit: "ḥōdeš", gloss: "month, new moon", alts: ["month", "new moon"], pos: "noun", chapter: 8, freq: 283 },
  { id: "sadeh", hebrew: "שָׂדֶה", translit: "śādeh", gloss: "field", alts: [], pos: "noun", chapter: 8, freq: 329 },

  // Ch 6 — world / body / cult
  { id: "yad", hebrew: "יָד", translit: "yād", gloss: "hand", alts: ["power"], pos: "noun", chapter: 8, freq: 1617 },
  { id: "peh", hebrew: "פֶּה", translit: "peh", gloss: "mouth", alts: [], pos: "noun", chapter: 8, freq: 498 },
  { id: "midbar", hebrew: "מִדְבָּר", translit: "midbār", gloss: "wilderness, desert", alts: ["wilderness", "desert"], pos: "noun", chapter: 8, freq: 271 },
  { id: "ets", hebrew: "עֵץ", translit: "ʿēṣ", gloss: "tree, wood", alts: ["tree", "wood"], pos: "noun", chapter: 8, freq: 330 },
  { id: "lehem", hebrew: "לֶחֶם", translit: "leḥem", gloss: "bread, food", alts: ["bread", "food"], pos: "noun", chapter: 8, freq: 296 },
  { id: "basar", hebrew: "בָּשָׂר", translit: "bāśār", gloss: "flesh, meat", alts: ["flesh", "meat", "body"], pos: "noun", chapter: 8, freq: 269 },
  { id: "dam", hebrew: "דָּם", translit: "dām", gloss: "blood", alts: [], pos: "noun", chapter: 8, freq: 360 },
  { id: "ohel", hebrew: "אֹהֶל", translit: "ʾōhel", gloss: "tent", alts: [], pos: "noun", chapter: 8, freq: 348 },

  // Ch 7 — theological nouns
  { id: "shalom", hebrew: "שָׁלוֹם", translit: "šālôm", gloss: "peace, welfare", alts: ["peace", "welfare", "wholeness"], pos: "noun", chapter: 8, freq: 237 },
  { id: "hesed", hebrew: "חֶסֶד", translit: "ḥesed", gloss: "loyalty, steadfast love", alts: ["steadfast love", "kindness", "loyalty", "mercy"], pos: "noun", chapter: 8, freq: 249 },
  { id: "emet", hebrew: "אֱמֶת", translit: "ʾĕmet", gloss: "truth, faithfulness", alts: ["truth", "faithfulness"], pos: "noun", chapter: 8, freq: 127 },
  { id: "tsedaqah", hebrew: "צְדָקָה", translit: "ṣədāqâ", gloss: "righteousness", alts: ["justice"], pos: "noun", chapter: 8, freq: 157 },
  { id: "berit", hebrew: "בְּרִית", translit: "bərît", gloss: "covenant", alts: ["treaty"], pos: "noun", chapter: 8, freq: 287 },
  { id: "hattat", hebrew: "חַטָּאת", translit: "ḥaṭṭāʾt", gloss: "sin, sin offering", alts: ["sin", "sin offering"], pos: "noun", chapter: 8, freq: 294 },
  { id: "kavod", hebrew: "כָּבוֹד", translit: "kābôd", gloss: "glory, honor", alts: ["glory", "honor"], pos: "noun", chapter: 8, freq: 200 },
  { id: "or", hebrew: "אוֹר", translit: "ʾôr", gloss: "light", alts: [], pos: "noun", chapter: 8, freq: 120 },
  { id: "hoshek", hebrew: "חֹשֶׁךְ", translit: "ḥōšek", gloss: "darkness", alts: [], pos: "noun", chapter: 8, freq: 80 },
  { id: "hayyim", hebrew: "חַיִּים", translit: "ḥayyîm", gloss: "life", alts: [], pos: "noun", chapter: 8, freq: 150 },
  { id: "mavet", hebrew: "מָוֶת", translit: "māwet", gloss: "death", alts: [], pos: "noun", chapter: 8, freq: 160 },
  { id: "mitsvah", hebrew: "מִצְוָה", translit: "miṣwâ", gloss: "commandment", alts: ["commandment", "command"], pos: "noun", chapter: 8, freq: 181 },
  { id: "milhamah", hebrew: "מִלְחָמָה", translit: "milḥāmâ", gloss: "war, battle", alts: ["war", "battle"], pos: "noun", chapter: 8, freq: 319 },
  { id: "zera", hebrew: "זֶרַע", translit: "zeraʿ", gloss: "seed, offspring", alts: ["seed", "offspring", "descendants"], pos: "noun", chapter: 8, freq: 229 },
  { id: "shabbat", hebrew: "שַׁבָּת", translit: "šabbāt", gloss: "Sabbath", alts: ["sabbath"], pos: "noun", chapter: 8, freq: 111 },
  { id: "ehad", hebrew: "אֶחָד", translit: "ʾeḥād", gloss: "one", alts: ["1", "first"], pos: "adj", chapter: 8, freq: 970 },
  { id: "shenayim", hebrew: "שְׁנַיִם", translit: "šənayim", gloss: "two", alts: ["2"], pos: "noun", chapter: 8, freq: 769 },
  { id: "shalosh", hebrew: "שָׁלֹשׁ", translit: "šālōš", gloss: "three", alts: ["3"], pos: "noun", chapter: 8, freq: 430 },
  { id: "arba", hebrew: "אַרְבַּע", translit: "ʾarbaʿ", gloss: "four", alts: ["4"], pos: "noun", chapter: 8, freq: 318 },
  { id: "hamesh", hebrew: "חָמֵשׁ", translit: "ḥāmēš", gloss: "five", alts: ["5"], pos: "noun", chapter: 8, freq: 343 },
  { id: "shesh", hebrew: "שֵׁשׁ", translit: "šēš", gloss: "six", alts: ["6"], pos: "noun", chapter: 8, freq: 273 },
  { id: "sheba", hebrew: "שֶׁבַע", translit: "šebaʿ", gloss: "seven", alts: ["7"], pos: "noun", chapter: 8, freq: 394 },
  { id: "eser", hebrew: "עֶשֶׂר", translit: "ʿeśer", gloss: "ten", alts: ["10"], pos: "noun", chapter: 8, freq: 316 },
  { id: "meah", hebrew: "מֵאָה", translit: "mēʾâ", gloss: "hundred", alts: ["100"], pos: "noun", chapter: 8, freq: 583 },
  { id: "eleph", hebrew: "אֶלֶף", translit: "ʾelep", gloss: "thousand", alts: ["1000"], pos: "noun", chapter: 8, freq: 505 },
