...
export const VOCAB: VocabItem[] = [
  ...
  { id: "sham", hebrew: "שָׁם", translit: "šām", gloss: "there", alts: [], pos: "particle", chapter: 14, freq: 833 },
  { id: "raq", hebrew: "רַק", translit: "raq", gloss: "only", alts: ["only", "except"], pos: "particle", chapter: 14, freq: 109 },
  { id: "na", hebrew: "נָא", translit: "nāʾ", gloss: "please, now", alts: ["please", "now", "I pray"], pos: "particle", chapter: 14, freq: 405 },
  { id: "at", hebrew: "אַתְּ", translit: "ʾatt", gloss: "you (f.s.)", alts: ["you"], pos: "pron", chapter: 14, freq: 74 },

  { id: "hadash", hebrew: "חָדָשׁ", translit: "ḥādāš", gloss: "new", alts: [], pos: "adj", chapter: 14, freq: 53 },
  { id: "zakar", hebrew: "זָכָר", translit: "zākār", gloss: "male", alts: [], pos: "noun", chapter: 14, freq: 82 },
  { id: "neqebah", hebrew: "נְקֵבָה", translit: "nəqēbâ", gloss: "female", alts: [], pos: "noun", chapter: 14, freq: 22 },

  // extras parked from earlier ch 3 (not BBH ch. 3)

  // Ch 6 — world / body / cult
  { id: "peh", hebrew: "פֶּה", translit: "peh", gloss: "mouth", alts: [], pos: "noun", chapter: 14, freq: 498 },
  { id: "dam", hebrew: "דָּם", translit: "dām", gloss: "blood", alts: [], pos: "noun", chapter: 14, freq: 360 },
  { id: "ohel", hebrew: "אֹהֶל", translit: "ʾōhel", gloss: "tent", alts: [], pos: "noun", chapter: 14, freq: 348 },

  // Ch 7 — theological nouns
  { id: "shalom", hebrew: "שָׁלוֹם", translit: "šālôm", gloss: "peace, welfare", alts: ["peace", "welfare", "wholeness"], pos: "noun", chapter: 14, freq: 237 },
  { id: "emet", hebrew: "אֱמֶת", translit: "ʾĕmet", gloss: "truth, faithfulness", alts: ["truth", "faithfulness"], pos: "noun", chapter: 14, freq: 127 },
  { id: "tsedaqah", hebrew: "צְדָקָה", translit: "ṣədāqâ", gloss: "righteousness", alts: ["justice"], pos: "noun", chapter: 14, freq: 157 },
  { id: "or", hebrew: "אוֹר", translit: "ʾôr", gloss: "light", alts: [], pos: "noun", chapter: 14, freq: 120 },
  { id: "hoshek", hebrew: "חֹשֶׁךְ", translit: "ḥōšek", gloss: "darkness", alts: [], pos: "noun", chapter: 14, freq: 80 },
  { id: "hayyim", hebrew: "חַיִּים", translit: "ḥayyîm", gloss: "life", alts: [], pos: "noun", chapter: 14, freq: 150 },
  { id: "mitsvah", hebrew: "מִצְוָה", translit: "miṣwâ", gloss: "commandment", alts: ["commandment", "command"], pos: "noun", chapter: 14, freq: 181 },
  { id: "zera", hebrew: "זֶרַע", translit: "zeraʿ", gloss: "seed, offspring", alts: ["seed", "offspring", "descendants"], pos: "noun", chapter: 14, freq: 229 },
  { id: "shabbat", hebrew: "שַׁבָּת", translit: "šabbāt", gloss: "Sabbath", alts: ["sabbath"], pos: "noun", chapter: 14, freq: 111 },

  // Ch 8 — core verbs
  { id: "bo", hebrew: "בּוֹא", translit: "bôʾ", gloss: "to come, go in", alts: ["come", "enter", "go in"], pos: "verb", chapter: 14, freq: 2570 },
  { id: "diber", hebrew: "דִּבֶּר", translit: "dibber", gloss: "to speak", alts: ["speak"], pos: "verb", chapter: 14, freq: 1136 },
  { id: "shub", hebrew: "שׁוּב", translit: "šûb", gloss: "to return", alts: ["return", "turn back", "repent"], pos: "verb", chapter: 14, freq: 1056 },
  { id: "laqah", hebrew: "לָקַח", translit: "lāqaḥ", gloss: "to take", alts: ["take", "receive"], pos: "verb", chapter: 14, freq: 967 },
  { id: "alah", hebrew: "עָלָה", translit: "ʿālâ", gloss: "to go up", alts: ["go up", "ascend", "offer up"], pos: "verb", chapter: 14, freq: 894 },
  { id: "qara", hebrew: "קָרָא", translit: "qārāʾ", gloss: "to call, read", alts: ["call", "read", "proclaim"], pos: "verb", chapter: 14, freq: 736 },
  { id: "qum", hebrew: "קוּם", translit: "qûm", gloss: "to arise, stand", alts: ["arise", "stand up", "rise"], pos: "verb", chapter: 14, freq: 627 },

  // Ch 9 — more verbs
  { id: "mut", hebrew: "מוּת", translit: "mût", gloss: "to die", alts: ["die"], pos: "verb", chapter: 14, freq: 835 },
  { id: "natan-nasa", hebrew: "נָשָׂא", translit: "nāśāʾ", gloss: "to lift, carry, bear", alts: ["lift", "carry", "bear", "raise"], pos: "verb", chapter: 14, freq: 659 },
  { id: "naphal", hebrew: "נָפַל", translit: "nāpal", gloss: "to fall", alts: ["fall"], pos: "verb", chapter: 14, freq: 435 },
  { id: "yare", hebrew: "יָרֵא", translit: "yārēʾ", gloss: "to fear", alts: ["fear", "be afraid", "revere"], pos: "verb", chapter: 14, freq: 334 },
  { id: "ahab", hebrew: "אָהַב", translit: "ʾāhēb", gloss: "to love", alts: ["love"], pos: "verb", chapter: 14, freq: 217 },
  { id: "bara", hebrew: "בָּרָא", translit: "bārāʾ", gloss: "to create", alts: ["create"], pos: "verb", chapter: 14, freq: 54 },
  { id: "banah", hebrew: "בָּנָה", translit: "bānâ", gloss: "to build", alts: ["build"], pos: "verb", chapter: 14, freq: 377 },
  { id: "abad", hebrew: "עָבַד", translit: "ʿābad", gloss: "to serve, work", alts: ["serve", "work", "worship"], pos: "verb", chapter: 14, freq: 289 },
  { id: "hata", hebrew: "חָטָא", translit: "ḥāṭāʾ", gloss: "to sin", alts: ["sin", "miss"], pos: "verb", chapter: 14, freq: 240 },

  // Ch 10
  { id: "yarad", hebrew: "יָרַד", translit: "yārad", gloss: "to go down", alts: ["go down", "descend"], pos: "verb", chapter: 14, freq: 380 },
  { id: "amad", hebrew: "עָמַד", translit: "ʿāmad", gloss: "to stand", alts: ["stand"], pos: "verb", chapter: 14, freq: 524 },
  { id: "hayah-live", hebrew: "חָיָה", translit: "ḥāyâ", gloss: "to live", alts: ["live", "revive"], pos: "verb", chapter: 14, freq: 283 },
  { id: "gadal", hebrew: "גָּדַל", translit: "gādal", gloss: "to be great, grow", alts: ["be great", "grow", "magnify"], pos: "verb", chapter: 14, freq: 117 },
  { id: "yakol", hebrew: "יָכֹל", translit: "yākōl", gloss: "to be able", alts: ["be able", "prevail", "can"], pos: "verb", chapter: 14, freq: 193 },
  { id: "qarab", hebrew: "קָרַב", translit: "qārab", gloss: "to draw near", alts: ["draw near", "approach", "offer"], pos: "verb", chapter: 14, freq: 280 },
  { id: "lamad", hebrew: "לָמַד", translit: "lāmad", gloss: "to learn, teach", alts: ["learn", "teach"], pos: "verb", chapter: 14, freq: 87 },
  { id: "shaphat", hebrew: "שָׁפַט", translit: "šāpaṭ", gloss: "to judge", alts: ["judge", "govern"], pos: "verb", chapter: 14, freq: 204 },
  { id: "rabah", hebrew: "רָבָה", translit: "rābâ", gloss: "to be many, multiply", alts: ["multiply", "increase", "be many"], pos: "verb", chapter: 14, freq: 229 },
  { id: "bahar", hebrew: "בָּחַר", translit: "bāḥar", gloss: "to choose", alts: ["choose"], pos: "verb", chapter: 14, freq: 164 },
  { id: "yalad", hebrew: "יָלַד", translit: "yālad", gloss: "to bear, beget", alts: ["bear", "beget", "give birth"], pos: "verb", chapter: 14, freq: 499 },
  { id: "shatah", hebrew: "שָׁתָה", translit: "šātâ", gloss: "to drink", alts: ["drink"], pos: "verb", chapter: 14, freq: 217 },
  { id: "sane", hebrew: "שָׂנֵא", translit: "śānēʾ", gloss: "to hate", alts: ["hate"], pos: "verb", chapter: 14, freq: 148 },

  // Ch 11
  { id: "yasha", hebrew: "יָשַׁע", translit: "yāšaʿ", gloss: "to save", alts: ["save", "deliver"], pos: "verb", chapter: 14, freq: 205 },
  { id: "azar", hebrew: "עָזַר", translit: "ʿāzar", gloss: "to help", alts: ["help"], pos: "verb", chapter: 14, freq: 82 },
  { id: "baqash", hebrew: "בִּקֵּשׁ", translit: "biqqēš", gloss: "to seek", alts: ["seek"], pos: "verb", chapter: 14, freq: 225 },
  { id: "darash", hebrew: "דָּרַשׁ", translit: "dāraš", gloss: "to inquire, seek", alts: ["inquire", "seek", "require"], pos: "verb", chapter: 14, freq: 165 },
  { id: "hithpallel", hebrew: "הִתְפַּלֵּל", translit: "hitpallēl", gloss: "to pray", alts: ["pray"], pos: "verb", chapter: 14, freq: 84 },
  { id: "hishtahawah", hebrew: "הִשְׁתַּחֲוָה", translit: "hištaḥăwâ", gloss: "to bow down, worship", alts: ["bow down", "worship", "prostrate"], pos: "verb", chapter: 14, freq: 172 },
  { id: "hallel", hebrew: "הִלֵּל", translit: "hillēl", gloss: "to praise", alts: ["praise"], pos: "verb", chapter: 14, freq: 146 },
  { id: "bakah", hebrew: "בָּכָה", translit: "bākâ", gloss: "to weep", alts: ["weep", "cry"], pos: "verb", chapter: 14, freq: 114 },
  { id: "gaal", hebrew: "גָּאַל", translit: "gāʾal", gloss: "to redeem", alts: ["redeem"], pos: "verb", chapter: 14, freq: 104 },
  { id: "salah", hebrew: "סָלַח", translit: "sālaḥ", gloss: "to forgive", alts: ["forgive", "pardon"], pos: "verb", chapter: 14, freq: 47 },
  { id: "shakah", hebrew: "שָׁכַח", translit: "šākaḥ", gloss: "to forget", alts: ["forget"], pos: "verb", chapter: 14, freq: 102 },
  { id: "tsaaq", hebrew: "צָעַק", translit: "ṣāʿaq", gloss: "to cry out", alts: ["cry out", "call out"], pos: "verb", chapter: 14, freq: 55 },
  { id: "nathan-natsal", hebrew: "נָצַל", translit: "nāṣal", gloss: "to deliver, snatch", alts: ["deliver", "rescue", "snatch"], pos: "verb", chapter: 14, freq: 213 },
  { id: "qadash", hebrew: "קָדַשׁ", translit: "qādaš", gloss: "to be holy, consecrate", alts: ["be holy", "consecrate", "sanctify"], pos: "verb", chapter: 14, freq: 171 },

  // Ch 12
  { id: "patah", hebrew: "פָּתַח", translit: "pātaḥ", gloss: "to open", alts: ["open"], pos: "verb", chapter: 14, freq: 136 },
  { id: "sagar", hebrew: "סָגַר", translit: "sāgar", gloss: "to close, shut", alts: ["close", "shut"], pos: "verb", chapter: 14, freq: 91 },
  { id: "kasah", hebrew: "כָּסָה", translit: "kāsâ", gloss: "to cover", alts: ["cover", "conceal"], pos: "verb", chapter: 14, freq: 153 },
  { id: "galah", hebrew: "גָּלָה", translit: "gālâ", gloss: "to uncover, go into exile", alts: ["uncover", "reveal", "exile", "go into exile"], pos: "verb", chapter: 14, freq: 187 },
  { id: "asaph", hebrew: "אָסַף", translit: "ʾāsap", gloss: "to gather", alts: ["gather", "collect"], pos: "verb", chapter: 14, freq: 200 },
  { id: "karat", hebrew: "כָּרַת", translit: "kārat", gloss: "to cut, cut off", alts: ["cut", "cut off", "make a covenant"], pos: "verb", chapter: 14, freq: 289 },
  { id: "zabah", hebrew: "זָבַח", translit: "zābaḥ", gloss: "to sacrifice", alts: ["sacrifice", "slaughter"], pos: "verb", chapter: 14, freq: 134 },
  { id: "mashah", hebrew: "מָשַׁח", translit: "māšaḥ", gloss: "to anoint", alts: ["anoint"], pos: "verb", chapter: 14, freq: 70 },
  { id: "taher", hebrew: "טָהֵר", translit: "ṭāhēr", gloss: "to be clean", alts: ["be clean", "purify"], pos: "verb", chapter: 14, freq: 94 },
  { id: "tame", hebrew: "טָמֵא", translit: "ṭāmēʾ", gloss: "to be unclean", alts: ["be unclean", "defile"], pos: "verb", chapter: 14, freq: 162 },
  { id: "labash", hebrew: "לָבַשׁ", translit: "lābaš", gloss: "to put on, wear", alts: ["wear", "put on", "clothe"], pos: "verb", chapter: 14, freq: 112 },
  { id: "qabar", hebrew: "קָבַר", translit: "qābar", gloss: "to bury", alts: ["bury"], pos: "verb", chapter: 14, freq: 133 },
  { id: "yarash", hebrew: "יָרַשׁ", translit: "yāraš", gloss: "to inherit, possess", alts: ["inherit", "possess", "dispossess"], pos: "verb", chapter: 14, freq: 232 },
  { id: "nata", hebrew: "נָטַע", translit: "nāṭaʿ", gloss: "to plant", alts: ["plant"], pos: "verb", chapter: 14, freq: 59 },

  // Ch 13
  { id: "laham", hebrew: "לָחַם", translit: "lāḥam", gloss: "to fight", alts: ["fight", "wage war"], pos: "verb", chapter: 14, freq: 177 },
  { id: "nakah", hebrew: "נָכָה", translit: "nākâ", gloss: "to strike", alts: ["strike", "smite", "hit"], pos: "verb", chapter: 14, freq: 501 },
  { id: "harag", hebrew: "הָרַג", translit: "hārag", gloss: "to kill", alts: ["kill", "slay"], pos: "verb", chapter: 14, freq: 167 },
  { id: "abad-perish", hebrew: "אָבַד", translit: "ʾābad", gloss: "to perish, destroy", alts: ["perish", "destroy", "be lost"], pos: "verb", chapter: 14, freq: 185 },
  { id: "shabar", hebrew: "שָׁבַר", translit: "šābar", gloss: "to break", alts: ["break"], pos: "verb", chapter: 14, freq: 148 },
  { id: "radaph", hebrew: "רָדַף", translit: "rādap", gloss: "to pursue", alts: ["pursue", "chase"], pos: "verb", chapter: 14, freq: 144 },
  { id: "nus", hebrew: "נוּס", translit: "nûs", gloss: "to flee", alts: ["flee"], pos: "verb", chapter: 14, freq: 160 },
  { id: "lakad", hebrew: "לָכַד", translit: "lākad", gloss: "to capture", alts: ["capture", "catch"], pos: "verb", chapter: 14, freq: 121 },
  { id: "shaal", hebrew: "שָׁאַל", translit: "šāʾal", gloss: "to ask", alts: ["ask", "inquire", "request"], pos: "verb", chapter: 14, freq: 176 },
  { id: "anah", hebrew: "עָנָה", translit: "ʿānâ", gloss: "to answer, afflict", alts: ["answer", "reply", "afflict"], pos: "verb", chapter: 14, freq: 316 },
  { id: "ganab", hebrew: "גָּנַב", translit: "gānab", gloss: "to steal", alts: ["steal"], pos: "verb", chapter: 14, freq: 40 },
  { id: "shamad", hebrew: "שָׁמַד", translit: "šāmad", gloss: "to destroy", alts: ["destroy", "annihilate"], pos: "verb", chapter: 14, freq: 90 },
  { id: "asar", hebrew: "אָסַר", translit: "ʾāsar", gloss: "to bind, imprison", alts: ["bind", "imprison", "tie"], pos: "verb", chapter: 14, freq: 73 },
  { id: "natsar", hebrew: "נָצַר", translit: "nāṣar", gloss: "to watch, guard", alts: ["watch", "guard", "keep"], pos: "verb", chapter: 14, freq: 63 },
